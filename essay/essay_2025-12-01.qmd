...
*update I:* Jason Koebler from 404 media recently wrote this article on how Flock ["left at least 60 of its people-tracking Condor PTZ cameras live streaming and exposed to the open internet."](https://www.404media.co/r/a43147f7?m=e23fcb51-2df3-4179-afdf-b38ab110a6c5)

*update II:* After backlash, [Ring cancelled its partnership with Flock Safety in February 2026](https://www.cnn.com/2026/02/13/tech/amazon-ring-flock-partnership-ice), following significant public backlash after a Super Bowl ad. The integration never launched, so no Ring customer videos were ever sent to Flock Safety Ring.

---

## 1. introduction

Over the past few years, consumer/government smart-camera ecosystems have come under increased scrutiny of violating personal privacy. In [September 2025, Amazon announced a range of new 2K and 4K smart-camera devices with new AI facial recognition features](https://web.archive.org/web/20251001082647/https://www.theverge.com/news/788290/ring-amazon-hardware-event-price-specs) that stores and processes the **facial embeddings of people passing in front of a Ring camera** if the Familiar Faces feature is enabled ([requires a compatible Ring subscription, and is not available in Texas, Illinois, Portland, or Quebec due to legislation](https://ring.com/support/articles/z3yhg/familiar-faces)).

Then, in October 2025, Amazon announced [Ring would partner with Flock Safety and share data with the government.](https://web.archive.org/web/20251201224341/https://www.cnbc.com/2025/10/16/amazon-ring-cameras-surveillance-law-enforcement-crime-police-investigations.html) To be clear, **Amazon is neither the first nor the only company** that has released AI facial recognition features - Clearview AI, with a more law-enformence focused user-base, have also come under scrutiny. 
...
<img class="essay_20251201_img01" src="media/essay_2025-12-01_img01.jpg" style="max-width: 100%; height: auto; display: block; margin: 1.5rem auto;" alt="Screenshot of website">
