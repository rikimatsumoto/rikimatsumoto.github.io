---
title: "Blog: how camera resolution and distance affects facial recognition accuracy (simplified analysis)"
...
This explains why a 4K camera can reliably detect faces at much longer distances than a 1080p webcam.

---

## 4. example: 4K camera at different distances
...
## 5. recognition risk zones (interactive risk heatmap)
...
#### **ZONE HIGH RISK: 200+ px face height (0.5–1.2 m with 1080p / 2–3 m with 4K)**

* high-quality facial landmarks
* very stable embedding vectors
* robust even under sunglasses, hats

#### **ZONE MEDIUM RISK: 112–200 px (1–2 m in 1080p / 3–4 m in 4K)**

* meets minimum ArcFace requirements
* recognition mostly reliable
* occlusions start impacting performance more heavily

#### **ZONE LOW RISK: 80–112 px**

* identity similarity fluctuates
* side angles >30° become problematic

#### **ZONE MINIMAL RISK: <80 px**

* recognition accuracy drops sharply
* <40 px → detection fails, recognition impossible

---

## 6. practical lessons and takeaways
...
A 4K camera offers roughly **2× the effective distance** of a 1080p camera for the same accuracy.
...
Noise reduces effective pixel quality.
