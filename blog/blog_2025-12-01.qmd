...
Understanding these variables are essential for evaluating **realistic privacy risks**:
...
In facial recognition standards, the term **inter-ocular distance (IOD)** - the number of pixels between the centers of the eyes - rather than full face height is used. To translate IOD into a simple geometric model, I assume the common anthropometric proportionality:

$$
\text{Face height} \approx 2.5 \times \text{IOD}.
$$

This ratio is consistent with standard facial alignment datasets and normalization procedures.
...
* The model assumes a frontal face and simple geometric projection; real-world scenes introduce additional variability.
